// Generated by @wagmi/cli@1.3.0 on 9/4/2023 at 3:04:20 PM
...
export const erc721MembershipMintSolABI = [
  {
    ...
    inputs: [
      ...
      { name: '_defaultImageUrl', internalType: 'string', type: 'string' },
      { name: '_defaultMemberRole', internalType: 'string', type: 'string' },
    ],
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    inputs: [
      { name: '_address', internalType: 'address', type: 'address' },
      { name: '_memberRole', internalType: 'string', type: 'string' },
    ],
    name: 'setMemberRole',
    outputs: [],
  },
